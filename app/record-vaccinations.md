...
**Record vaccinations** is the new simpler way to record vaccinations. The existing [Find a patient](https://guide.ravs.england.nhs.uk/finding-a-patient/) section will soon be removed.
